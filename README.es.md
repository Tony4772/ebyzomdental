...
### ▶ [**Prueba la demo en vivo**](https://demo.ebyzomdental.com)
...
[![EBYZOM dental — ficha de paciente con odontograma](docs/screenshots/patients.png)](https://demo.ebyzomdental.com)

<sub>[Web](https://www.ebyzomdental.com) · [Documentación](https://docs.ebyzomdental.com) · [Telegram](https://t.me/ebyzomdental) · [Más capturas ↓](#capturas-de-pantalla)</sub>

## ¿Por qué EBYZOM dental?
...
EBYZOM dental se construye sobre una premisa simple: **una plataforma abierta para clínicas dentales en todas partes**. No otra solución regional, sino una base global que cualquier clínica pueda adoptar, cualquier desarrollador pueda extender y cualquier comunidad pueda localizar.
...
Las clínicas merecen algo mejor que software cerrado y costoso de la década pasada. EBYZOM dental es la alternativa abierta.

## ✨ Copiloto IA

EBYZOM dental incluye un **asistente IA agentic integrado** que convierte toda la clínica en algo con lo que simplemente puede conversar. Pídale encontrar un paciente, liberar un espacio, perseguir un presupuesto sin respuesta, o informarle sobre el día por delante — en español o inglés — y actúa sobre sus datos reales.
...
- **Las escrituras preguntan primero.** Cualquier acción que modifique datos (reservas, pagos, ediciones) hace una pausa en medio de la conversación para su confirmación explita antes de ejecutarse.
...
Visite [**ebyzomdental.com**](https://www.ebyzomdental.com) para información del producto, características y detalles comerciales.

## Comunidad

Únase a nuestro [**canal de Telegram**](https://t.me/ebyzomdental) para soporte, ayuda con la instalación y preguntas.
...
EBYZOM dental utiliza una arquitectura modular tipo plugin. Cada funcionalidad es un módulo autónomo que:
- Declares sus modelos SQLAlchemy
...
**Limitación de uso:** No puede ofrecer EBYZOM dental como un SaaS comercial para la gestión de clínicas dentales.
