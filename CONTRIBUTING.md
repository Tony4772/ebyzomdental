# Contributing to EBYZOM dental

Thank you for your interest in contributing to EBYZOM dental! This document will help you understand how to contribute effectively.
...
EBYZOM dental uses the **BSL 1.1** license (Business Source License):
...
EBYZOM dental follows a layered architecture:
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/ebyzomdental.git
cd ebyzomdental
...
EBYZOM dental has a plugin architecture. See the full guide: [docs/technical/creating-modules.md](docs/technical/creating-modules.md)
...
Every contribution matters — from fixing typos to adding major features. We appreciate your time and effort in making EBYZOM dental better for the dental community.
