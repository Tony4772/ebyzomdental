...
| tenant_label                        | _ignored_ — EBYZOM dental's clinic_id wins   |
...
class PatientMapper:
    ...
    async def apply(
        ...
        *,
        ...
        # (deceased). EBYZOM dental's Patient status enum is binary
        ...
        await ctx.resolver.set(
            ...
            ebyzomdental_table="patients",
            ebyzomdental_id=patient.id,
        )
        return patient.id
