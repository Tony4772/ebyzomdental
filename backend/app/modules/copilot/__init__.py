"""Copilot module — conversational AI agent over EBYZOM dental (issue #81).
...
class CopilotModule(BaseModule):
    manifest = {
        "name": "copilot",
        "version": "0.1.0",
        "summary": "Conversational AI agent over EBYZOM dental, scoped to the caller's permissions.",
