...
All notable changes to EBYZOM dental are documented here. Format loosely
...
- **Open Sauce One Font** — Integrated the Open Sauce One font family for the landing page's typography.
...
- **Prebuilt images and a one-command install.** Tagging a release now
  builds and publishes `ghcr.io/martinezsalmeron/ebyzomdental-backend` and
