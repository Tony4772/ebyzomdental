...
EBYZOM dental holds patient health data. Treat anything that touches
...
[GitHub Security Advisories](https://github.com/martinezsalmeron/ebyzomdental/security/advisories/new).
...
if you run a pinned `EBYZOMDENTAL_VERSION`, upgrading is the fix path.
...
Findings against `demo.ebyzomdental.com` that only affect seeded demo data,
