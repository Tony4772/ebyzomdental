...
### ▶ [**Try the live demo**](https://demo.ebyzomdental.com)

Sign in with `admin@demo.clinic` / `demo1234` — full admin access to a seeded clinic.
Reset every night, so poke at anything.

[![EBYZOM dental — patient record with odontogram](docs/screenshots/patients.png)](https://demo.ebyzomdental.com)

<sub>[Website](https://www.ebyzomdental.com) · [Docs](https://docs.ebyzomdental.com) · [Telegram](https://t.me/ebyzomdental) · [More screenshots ↓](#screenshots)</sub>
...
EBYZOM dental is built on a simple premise: **one open platform for dental clinics everywhere**. Not another regional solution, but a global foundation that any clinic can adopt, any developer can extend, and any community can localize.
...
Clinics deserve better than closed, expensive software from the last decade. EBYZOM dental is the open alternative.

## ✨ AI Copilot

EBYZOM dental ships with a built-in **agentic AI assistant** that turns the whole clinic into something you can simply talk to. Ask it to find a patient, free up a slot, chase an unanswered budget, or brief you on the day ahead — in plain Spanish or English — and it acts on your real data.
...
Visit [**ebyzomdental.com**](https://www.ebyzomdental.com) for product info, features, and commercial details.

## Community

Join our [**Telegram channel**](https://t.me/ebyzomdental) for support, installation help, and questions.
...
```bash
curl -O https://raw.githubusercontent.com/martinezsalmeron/ebyzomdental/main/docker-compose.prod.yml
curl -O https://raw.githubusercontent.com/martinezsalmeron/ebyzomdental/main/Caddyfile
curl -o .env https://raw.githubusercontent.com/martinezsalmeron/ebyzomdental/main/.env.prod.example
...
Images: [`ebyzomdental-backend`](https://github.com/martinezsalmeron/ebyzomdental/pkgs/container/ebyzomdental-backend) ·
[`ebyzomdental-frontend`](https://github.com/martinezsalmeron/ebyzomdental/pkgs/container/ebyzomdental-frontend)
...
EBYZOM dental uses a modular plugin architecture. Each feature is a self-contained module that:
...
**Additional Use Grant:** You may use EBYZOM dental in production, as long as you do not offer it as a commercial SaaS for dental clinic management.
