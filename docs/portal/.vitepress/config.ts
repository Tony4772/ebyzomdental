...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/martinezsalmeron/ebyzomdental",
      },
    ],
    editLink: {
      pattern:
        "https://github.com/martinezsalmeron/ebyzomdental/edit/main/docs/:path",
      text: "Edit this page on GitHub",
    },
    footer: {
      message:
        'Source: <a href="https://github.com/martinezsalmeron/ebyzomdental">github.com/martinezsalmeron/ebyzomdental</a>',
