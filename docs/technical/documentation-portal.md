...
| Route | Fragment URL |
|-------|--------------|
| `/patients` | `https://docs.ebyzomdental.com/help/patients.html` |
| `/patients/[id]` | `https://docs.ebyzomdental.com/help/patients_[id].html` |
| `/treatment-plans/new` | `https://docs.ebyzomdental.com/help/treatment-plans_new.html` |
...
2. Frontend `fetch('https://docs.ebyzomdental.com/<lang>/help/<slug>.html')`.
...
from `app.ebyzomdental.com` (tighten from `*` once the production app
origin is known).
...
| Domain | `docs.ebyzomdental.com`. Public, no auth. |
...
- Repo: `martinezsalmeron/ebyzomdental`
- Build context: `/`
...
| 7 | Link `docs.ebyzomdental.com` from the commercial site | external (out of repo) |
