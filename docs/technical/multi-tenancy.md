...
Documento de arquitectura. Define el modelo de aislamiento actual (self-hosted) y las costuras que permitirán un módulo externo `ebyzomdental-saas` con DB-per-tenant sin tocar core.
...
Un futuro módulo `ebyzomdental-saas` no toca core. Implementa:
