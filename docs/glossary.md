...
Source of truth for EBYZOM dental terminology. Code is in English; UI strings
...
| Entry point | `pyproject.toml` registration under `[project.entry-points."ebyzomdental.modules"]` so the loader can discover the module. |
